...
В окне `Оборудование` отображается иерархия устройств, слева от которых располагаются индикаторы текущего состояния канала связи с устройством (*канал связи отключен*, *канал связи включен* и *устройство не отвечает*):
