...
<dd>Позволяет изменять внешний вид и поведение графического клиента.
  ...
  <dd>В текущей версии параметр не действует: мигание окна не реализовано. Для привлечения внимания используйте звуковое оповещение и счётчик неквитированных событий в строке состояния.</dd>
