...
Элементами подсистемы МЭК являются направления, определяющие каналы данных: IP-адрес для МЭК-104 и серийный порт для МЭК-101. Одно направление может обеспечивать соединение с несколькими устройствами.
