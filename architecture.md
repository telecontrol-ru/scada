...
Предоставляется прозрачный доступ к модели данных удаленного устройства. Смотрите [МЭК-61850](client#iec-61850) в Клиенте и [проектирование](development#iec-61850).
