...
При выборе объекта в панели объектов или таблице можно перейти к мнемосхеме, содержащей этот объект, при помощи команды «Мнемосхема» из панели команд или контекстного меню. Команда доступна при наличии подключения к серверу.
