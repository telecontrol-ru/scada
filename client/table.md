...
Окно дополняется [панелью инструментов](../workbench/#table-toolbar) над сеткой с этими же командами, столбцом «Достоверность» и моноширинным отображением значений и меток времени.
