...
В [экспериментальном интерфейсе](../workbench/#table-toolbar) окно дополняется панелью инструментов над сеткой с этими же командами, столбцом «Достоверность» и моноширинным отображением значений и меток времени.

## Контекстное меню

При клике ПКМ по строке таблицы отображается контекстное меню, содержащее следующие команды. Команды, неприменимые к текущему выделению (например, *Удалить* или *Сместить* без выделенной строки), отображаются серым:
...
Вместо выбора объекта из панели объектов, в первый столбец таблицы можно ввести формулу. Формулы позволяют отображать вычисляемые значения на основе данных одного или нескольких объектов. Поддерживаются ссылки на объекты по алиасу, арифметические операции и встроенные функции.

Смотрите полное описание синтаксиса в разделе [Формулы](../formulas).
