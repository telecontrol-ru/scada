...
мигание окна, звук) и — там, где система поддерживает синтез речи, — речевое
оповещение. Недоступный флажок поясняет причину во всплывающей подсказке:
речевое оповещение доступно только в Windows-сборке. Списки внизу — «Язык»,
«Стиль» и «Цветовая схема».
...
Выбор, сделанный в [диалоге настроек](#settings-dialog), хранится в
