...
сообщение об успехе управления и поведение при событиях (показ, скрытие,
мигание окна, звук). Недоступный флажок поясняет причину во всплывающей
подсказке. Списки внизу — «Язык», «Стиль» и «Цветовая схема».
