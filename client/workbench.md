...
Оформление выбирается в диалоге *Настройки → Настройки…*, списком
...
В окне ретрансляции (список правил передачи «сигнал → адрес» устройства)
слева отображается список направлений —
