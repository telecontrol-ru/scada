...
рабочем экране оператора: сверху доминирующий график (примерно две трети
экрана), под ним — таблица активных тревог (журнал событий в режиме
текущих, только неквитированные события). Сводка по важности при этом
