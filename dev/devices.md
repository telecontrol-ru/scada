...
Окно оборудования может быть отображено посредством вызова вкладки из главного меню: *Дополнительно — Оборудование*.
...
Для редактирования параметров элемента следует из контекстного меню элемента выбрать пункт *Свойства*.

### Карта адресов

У устройства, кроме вкладок с его собственными параметрами, есть вкладка
**«Карта адресов»** — перечень сигналов, которые с него читаются, с колонками
«Сигнал», «Тип», «Адрес» (IOA) и «Идентификатор узла». Вкладка доступна только
для чтения: адрес задаётся в параметрах самого объекта данных, в поле «Канал»
(см. [Объекты данных](data-items)). Карта отвечает на обратный вопрос — какой
объект стоит за адресом, пришедшим от устройства, — и той же картой
пользуется [разбор кадра](../client/device-watch/) в окне наблюдения.
...
<dt>Архив событий</dt>
<dd>Указывается архив для хранения сетевого трафика обмена данными с устройствами с целью его последующего анализа и сохранения в текстовый лог файл. Просмотреть и изменить список архивов можно выбрав из вкладки главного меню [Дополнительно] — [Базы данных].</dd>
...
<dt>Архив событий</dt>
<dd>Указывается архив для хранения сетевого трафика обмена данными с конкретным устройством с целью его последующего анализа и сохранения в текстовый лог файл. Просмотреть и изменить список архивов можно выбрав из вкладки главного меню [Дополнительно] — [Базы данных].</dd>
