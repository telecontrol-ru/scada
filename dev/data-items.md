...
Доступ к просмотру и редактированию конфигурации объекта данных возможен через пункты меню `Свойства` для одного объекта или `Свойства элемента` для группы объектов.
