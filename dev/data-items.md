...
Ниже сразу же строится предварительный просмотр — таблица с номером строки,
«Имя», «Идентификатор узла», «Адрес» и «Статус». В столбце «Статус» строка помечается
...
Шаг «Шаблон» с предварительным просмотром:
